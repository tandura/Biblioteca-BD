...
{
    public delegate void StarSelectedEventHandler(object sender, EventArgs e);

    class FiveStarRating : System.Windows.Forms.Control
    {
        private int m_leftMargin = 2;
        private int m_rightMargin = 2;
        private int m_topMargin = 2;
        private int m_bottomMargin = 2;
        private int m_starSpacing = 8;
        private int m_starCount = 5;
        private Rectangle[] m_starAreas;
        
        private float m_outlineThickness = 1;
        
        private Color m_outlineColor  = Color.DarkGray;
        private Color m_selectedColor = Color.RoyalBlue;
        ...
        public event StarSelectedEventHandler StarSelected;
        ...
        protected void DrawStar(Graphics g, Rectangle rect, int starAreaIndex)
        {
            ...
            if (m_hovering && m_hoverStar > starAreaIndex)
            {
                ...
                if ((!m_hovering) && m_selectedStar > starAreaIndex)
                {
                    fillBrush = new LinearGradientBrush(rect,
